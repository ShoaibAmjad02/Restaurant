    ...
    operations = [
        migrations.RunSQL(
            sql="CREATE TABLE IF NOT EXISTS loyalty_cards_loyaltycard ("
                ...
                "  first_card_popup_shown boolean NOT NULL,"
                "  created_at timestamptz NOT NULL,"
                "  updated_at timestamptz NOT NULL,"
                "  user_id bigint NULL REFERENCES users_user (id) ON DELETE CASCADE"
                ");",
        ...
        migrations.RunSQL(
            sql="CREATE TABLE IF NOT EXISTS loyalty_cards_loyaltytransaction ("
                ...
                "  created_at timestamptz NOT NULL,"
                "  card_id bigint NOT NULL REFERENCES loyalty_cards_loyaltycard (id) ON DELETE CASCADE"
                ");",
